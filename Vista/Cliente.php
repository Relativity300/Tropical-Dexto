...
$listaUsuario = json_decode($controladorCliente->listarUsuario());
    ...
    <table border="1" class="table table-sriped table-bordered" id="listausuario">
        ...
        <tbody align="center">
            ...
            <tr>
                ...
                <td>
                <a href="../Controlador/controladorCliente.php?editarUsuario&idusuario=<?php echo $usuario->idusuario ?>" class="btn btn-info"><i class="fas fa-edit" aria-hidden="true"></i></a>
